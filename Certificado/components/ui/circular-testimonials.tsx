        ...
        <div className="relative w-full h-96 perspective-[1000px]" ref={imageContainerRef}>
          {testimonials.map((testimonial, index) => (
            <img
              ...
              className="absolute w-full h-full object-cover rounded-[1.5rem] shadow-[0_10px_30px_rgba(0,0,0,0.4)]"
        ...
        <div className="flex flex-col justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p
                className="mb-8 font-medium uppercase tracking-widest"
          ...
          <div className="flex gap-6 pt-12 md:pt-8">
            <button
              className="w-[3.5rem] h-[3.5rem] rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 cubic-bezier-[0.4,0,0.2,1] border border-white/10 hover:scale-110"
              onClick={handlePrev}
              style={{
